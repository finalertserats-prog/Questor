...
export function DemoRedeem() {
  ...
  return <div className="public-shell"><header className="public-bar"><Link to="/login" className="public-brand"><img src="/brand/questor-mark.webp" alt="" width={26} height={27} /><span>Questor</span></Link></header><main className="public-body"><div className="card auth-card" style={{ maxWidth: 520, margin: '0 auto' }}>
