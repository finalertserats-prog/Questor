...
describe('verdictOf', () => {
  ...
  it('shows no verdict at all while your blind review comes first', () => {
    expect(verdictOf({ blindReviewPending: true, humanRecommendation: 'PROCEED' }).source).toBe('pending');
  });
