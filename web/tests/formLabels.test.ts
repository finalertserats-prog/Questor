...
// RoleCreate reads the signed-in role only to word ATS errors; the markup under
// test does not depend on who is signed in.
vi.mock('../src/auth', () => ({ useAuth: () => ({ user: null }) }));
